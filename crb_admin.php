        ...
        <tr valign="top">
            ...
            <td>
                <select name="crb_show_after_content" id="crb_show_after_content">
                    ...
                    <option <?php if($crb_show_after_content == 'true') { echo 'selected="selected"'; } ?> value="true">Да</option>
                </select>
            </td>
        </tr>
        <?php
        ...
        <tr valign="top">
            ...
            <td>
                <select name="crb_hide_existing_links" id="crb_hide_existing_links">
                    ...
                    <option <?php if($crb_hide_existing_links == 'true') { echo 'selected="selected"'; } ?> value="true">Да</option>
                </select>
            </td>
        </tr>
        <?php
        ...
        <tr valign="top">
            ...
            <td>
                <select name="crb_show_latest" id="crb_show_latest">
                    ...
                    <option <?php if($crb_show_latest == 'true') { echo 'selected="selected"'; } ?> value="true">Да</option>
                </select>
            </td>
        </tr>
        <?php
...
<!--                    <option --><?php //if($crb_css_tuning == 'no') { echo 'selected="selected"'; } ?><!-- value="no">Нет загружать</option>-->
                    <option <?php if($crb_css_tuning == 'default') { echo 'selected="selected"'; } ?> value="default">Нет, все хорошо</option>
                    <option <?php if($crb_css_tuning == 'important') { echo 'selected="selected"'; } ?> value="important">Опция !important</option>
                </select>
            </td>
        ...
        <tr valign="top">
            ...
            <td>
                <select name="crb_content_filter" id="crb_content_filter">
                    <option <?php if ($crb_content_filter == 0) { echo 'selected="selected"'; } ?> value="0">Обычный режим</option>
                    <option <?php if ($crb_content_filter == 1) { echo 'selected="selected"'; } ?> value="1">Применить фильтры</option>
                </select>
            </td>
    ...
    static function css_override($crb_css_override) {
        ...
        ?>
        <tr valign="top">
            <th scope="row" colspan="3" style=""><h3>Параметры сетки</h3></th>
        </tr>
        <tr valign="top">
