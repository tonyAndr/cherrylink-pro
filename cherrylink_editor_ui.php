...
//     }
//     wp_register_script('cherrylink-js-main', $js_path, array('jquery', 'wp-blocks', 'wp-editor', 'wp-dom-ready', 'wp-plugins', 'wp-edit-post', 'wp-element'), LinkatePosts::get_linkate_version());
//     wp_enqueue_script('cherrylink-js-main');
// }
